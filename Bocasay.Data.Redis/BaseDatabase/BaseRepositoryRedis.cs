...
{
    public class BaseRepositoryRedis<T> : IBaseRepositoryRedis<T> where T : BaseDto
    {
        ...
        private void MergeIntoAllCollection(T item)
        {
        ...
        private void MergeIntoAllCollection(IEnumerable<T> items)
        {
